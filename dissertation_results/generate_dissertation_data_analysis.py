#!/usr/bin/env python3
"""
Comprehensive Data Analysis for Dissertation
...
### Target Variable
- **Default Rate**: {stats_df[stats_df['Metric'] == 'Default Rate (%)']['Value'].iloc[0]}% of loans default
- **Class Imbalance**: Significant imbalance requiring careful handling

### Text Features
- **Synthetic Text**: Generated for {missing_df[missing_df['Feature'] == 'description']['Missing_Count'].iloc[0] if 'description' in missing_df['Feature'].values else 'N/A'} missing descriptions
